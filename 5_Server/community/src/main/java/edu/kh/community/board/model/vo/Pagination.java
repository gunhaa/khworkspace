...
public class Pagination {
	...
	private int pageSize = 10;  // 목록 하단에 페이지 번호의 노출 개수
	...
	private void calculatePagination() {
		...
		// -> 마지막 페이지 번호는 ? 501/10= 50.1(올림처리) -> 51
...
//		prevPage = (currentPage - 1) / pageSize * pageSize + 1;
//		
//		if(prevPage==1) {
//			prevPage=1;
//		} else {
...
//		}
//		
//		nextPage = endPage = startPage+pageSize-1;
//		if(maxPage>nextPage) {
//			nextPage = nextPage +1;
//		} else {
//			nextPage= maxPage;
