...
public class ScopeServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		session.setAttribute("sessionValue", "500");
		session.setAttribute("message", "session Scope에 저장된 메시지 입니다.");
		// 4) application scope
		...
		application.setAttribute("appValue", "곧 점심시간 ^-^");
		application.setAttribute("message", "application Scope에 저장된 메시지 입니다.");
