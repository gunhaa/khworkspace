...
public class Employee {
	...
	public Employee(int empId, String empName, String empNo, String email, String phone, String deptCdoe,
	...
	public String toString() {
		return "Employee [empId=" + empId + ", empName=" + empName + ", empNo=" + empNo + ", email=" + email
				+ ", phone=" + phone + ", deptCdoe=" + deptCode + ", jobCode=" + jobCode + ", salLevel=" + salLevel
	...
	public void setDeptCode(String deptCdoe) {
		this.deptCode = deptCdoe;
	}
