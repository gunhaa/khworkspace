...
public class EmployeeView {
	...
	public void printList(List<Employee> empList) {
				//Employee 타입으로 제한된 리스트 == Employee만 담긴 List
		
		if(empList.isEmpty())  { //empList가 비어있는 경우 == 조회결가가 없을 경우
	...
	public void insertEmployee() {
		...
		System.out.println("부서 코드(D1 ~ D9) : ");
	...
	public void deleteEmployee() {
		...
		// EMPLOYEE2 테이블에서
	      ...
	      if(result>0) {
	    	  ...
	    	  System.out.println("일치하는 사원의 사번이 없습니다");
	      }
	...
	public void updateEmployee() {
		...
		int empId = inputEmpId(); // 사번 입력 받는 메소드 호출 후 결과값 반환 받기
	...
	public void updateBonus() {
		...
		if(result >0) {
			System.out.println("부서코드 보너스가 수정 되었습니다.");
		} else {
