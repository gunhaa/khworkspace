		...
		do {
			...
			try {
				...
				if(loginMember==null) {
					...
					case 1: 
						memberView.myInfo(loginMember);
						break;
					case 2: 
						memberView.selectAll();
						break;
					case 3: 
						memberView.updateMyInfo(loginMember);
						break;
					case 4: 
						memberView.updatePw(loginMember);
						break;
					case 5: 
						int result = memberView.secession(loginMember);
						//리턴값을 member로해서 loginMember=null;를 가져오면 왜 안됨?
						...
						break;
					case 6 :
						boardView.boardMenu(loginMember);
						break;
					case 9:  
						loginMember=null;
						break;
