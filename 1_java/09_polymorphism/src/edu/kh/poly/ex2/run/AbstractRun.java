...
import edu.kh.poly.ex2.model.service.HGHCalculator;
...
public class AbstractRun {
	...
	public static void main(String[] args) {
		...
		AbstractService Ser = new AbstractService();
		...
		//Calculator cal = new HGHCalculator();
		...
		//     ex) Run에 작성된 합,차,곱,몫을 출력하는 코드의 수정 업이
