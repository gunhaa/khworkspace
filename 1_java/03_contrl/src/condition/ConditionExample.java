...
public class ConditionExample {
	...
	public void ex4() {
		...
		String season; //아래 조건문 수행 결과를 저장할 변수를 미리 선언
		//한번 변수를 선언했으면 다음에 부를때는 String없이 변수만 입력해도 된다. String의 리터럴은 ""라서 ""를 사용해야한다.
		//봄 : 3,4,5
		...
		// else if( 6 <= month && month <= 8) 라고 표현할 수도있다.
