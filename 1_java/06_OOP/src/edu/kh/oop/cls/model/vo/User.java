...
public class User {
	...
	//매개변수 생성자
	// **사용되는 기술, 변수 : 매개변수, 오버로등(Overloading), this
	...
	public User(String userId, String userPw) {
				//매개 변수(전달 받은 값을 전달) : "test4" , "pass4"
		
		System.out.println("매개변수 생성자를 이용해서 User 객체 생성");
		System.out.println(userId + " / "+ userPw);
		
		//전달 받은 값을 필드에 초기화(값을 저장한다는 의미)(this 참조변수)
	...
	*/
	...
	public User(String userId) {} //매개변수의 같은 생성자가 없음
								  //-> 오버로딩 성립
	...
	//public User(String userName , String userPw , String Id) {} //에러
	//매개 변수의 개수, 타입, 순서가 모두 같아서 오버로딩 불가
	// -> 변수 명은 신경쓰지 않는다.
	...
	public void setUserGender(char userGentder) {
		this.userGender = userGentder;
	}
