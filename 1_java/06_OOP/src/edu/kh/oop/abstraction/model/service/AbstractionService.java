...
public class AbstractionService {
	...
	public void ex1() {
		...
		//new People(): 새로운 People 객체를 Heap 영역에 생성 한다.
		...
		//p1.name = "전혜선"; //The field People.net is not visible
		//직접 접근 방법
		p1.setName("전혜선"); // setter을 이용한 간접 접근 방법
		p1.setAge(19);
		p1.setGender('여');
		p1.setPhone("010-1234-1234");
		p1.setpNo("151112-1234567");
		p1.setAddress("서울시 강남고 테헤란로 KH정보교육원");
		
		System.out.println("p1의 name : "+ p1.getName());
		System.out.println("p1의 age : "+ p1.getAge());
		System.out.println("p1의 gender : "+ p1.getAddress());
		...
		p2.age = 22;
		p2.gender = '남';
		p2.phone = "010-3456-3456";
		p2.pNo = "444444-4444444";
		p2.address = "서울시 강남고 테헤란로 KH정보교육원 6층";
