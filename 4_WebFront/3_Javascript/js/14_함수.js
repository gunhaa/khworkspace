...
function clickCount(btn){
    num++;
    // document.querySelector("#btn1").innerText = num;
    // console.log(btn);
...
document.getElementById('btn2-3').addEventListener('click', ()=>{
    ...
    // printConsole( num => {price:num*100 , n: num}; //문법 오류, 화살표 다음에는 function 이 나와야함
