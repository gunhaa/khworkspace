...
SELECT * FROM MEMBER;
-- 프로필 이미지 수정 SQL 문
UPDATE BOARD SET IMG_PATH=#{} AND IMG_RENAME=#{} WHERE BOARD_NO=#{};
...
FROM (SELECT '웹접근경로' IMG_PATH, '변경명' IMG_RENAME, '원본명' IMG_ORIGINAL, 0 IMG_ORDER, 1507 BOARD_NO FROM DUAL

UNION ALL

SELECT '웹접근경로' IMG_PATH, '변경명' IMG_RENAME, '원본명' IMG_ORIGINAL, 1 IMG_ORDER, 1507 BOARD_NO FROM DUAL

UNION ALL

SELECT '웹접근경로' IMG_PATH, '변경명' IMG_RENAME, '원본명' IMG_ORIGINAL, 2 IMG_ORDER, 1507 BOARD_NO FROM DUAL)A;

SELECT * FROM BOARD;
-- 게시글 수정
UPDATE BOARD SET BOARD_TITLE=#{} ,BOARD_CONTENT=#{}, B_UPDATE_DATE=SYSDATE  WHERE BOARD_NO=#{} AND BOARD_CODE=#{};

-- 이미지 삭제
SELECT* FROM BOARD_IMG;
-- # $ 확인
DELETE FROM BOARD_IMG WHERE BOARD_NO=#{boardNo} AND IMG_ORDER IN (${deleteMap});
-- 이미지 수정
UPDATE BOARD_IMG SET IMG_PATH=#{} , IMG_RENAME=#{}, IMG_ORIGINAL=#{}, IMG_ORDER=#{} WHERE BOARD_NO=#{};
-- 이미지 삽입
INSERT BOARD_IMG VALUES(SEQ_IMG_NO, #{imagePath}, #{imageReName}, #{imageOriginal}, #{imageOrder} ,#{imageNo})

-- 게시글 삭제
UPDATE BOARD SET BOARD_DEL_FL = Y WHERE BOARD_NO=#{} AND BOARD_CODE=#{};
...
-- 댓글 샘플 데이터
INSERT INTO "COMMENT" VALUES (SEQ_COMMENT_NO.NEXTVAL, '부모 댓글1' , DEFAULT, DEFAULT, 1496,1,NULL);
INSERT INTO "COMMENT" VALUES (SEQ_COMMENT_NO.NEXTVAL, '부모 댓글2' , DEFAULT, DEFAULT, 1496,1,NULL);
INSERT INTO "COMMENT" VALUES (SEQ_COMMENT_NO.NEXTVAL, '부모 댓글3' , DEFAULT, DEFAULT, 1496,1,NULL);
-- 자식 댓글 1-1
INSERT INTO "COMMENT" VALUES (SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 1-1' , DEFAULT, DEFAULT, 1496,1, 1001);
INSERT INTO "COMMENT" VALUES (SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 1-2' , DEFAULT, DEFAULT, 1496,1, 1001);
INSERT INTO "COMMENT" VALUES (SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 1-3' , DEFAULT, DEFAULT, 1496,1, 1001);
-- 자식 댓글 2-1
INSERT INTO "COMMENT" VALUES (SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 2-1' , DEFAULT, DEFAULT, 1496,1, 1002);
INSERT INTO "COMMENT" VALUES (SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 2-2' , DEFAULT, DEFAULT, 1496,1, 1002);
INSERT INTO "COMMENT" VALUES (SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 2-3' , DEFAULT, DEFAULT, 1496,1, 1002);
-- 2-1 자식의 자식 댓글
INSERT INTO "COMMENT" VALUES (SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 2-1-1' , DEFAULT, DEFAULT, 1496,1, 1007);
COMMIT;
